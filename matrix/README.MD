...
|№|Завдання|Код|Результат|
|---|---|---|---|
|2|1. Створіть квадрат 5х5 (цикл - від 0 до 4) з блоків білого бетону (WHITE_CONCRETE), при чому на старті агент має стояти в точці в абсолютних координатах (world) - (0,4,0) із орієнтацією на захід (WEST). В квадраті - сформуйте головну діагональ (елементи в яких номер стовпчика збігається із номером рядку) із блоків червого бетону (RED_CONCRETE)<br>2. Створіть квадрат 10х10 (цикл - від 0 до 9) з блоків білого бетону (WHITE_CONCRETE), при чому на старті агент має стояти в точці в абсолютних координатах (world) - (0,4,0) із орієнтацією на захід (WEST). В квадраті - сформуйте головну діагональ (елементи в яких номер стовпчика збігається із номером рядку) із блоків червого бетону (RED_CONCRETE)<br>1. Створіть квадрат довільного розміру із довільного матеріалу в довільному місці із довільною початковою орієнтацією агента. В квадраті - сформуйте головну діагональ (елементи в яких номер стовпчика збігається із номером рядку) із блоків довільного типу, але так, щоб блоки діагоналі відрізнялися від блоків основного квадрату.<br>|наведено вище|<img src = "img/pattern02.png">|
## Зворотня діагональ
...
|№|Завдання|Код|Результат|
|---|---|---|---|
|3|1. Створіть квадрат 5х5 (цикл - від 0 до 4) з блоків білого бетону (WHITE_CONCRETE), при чому на старті агент має стояти в точці в абсолютних координатах (world) - (0,4,0) із орієнтацією на захід (WEST). В квадраті - сформуйте зворотню діагональ (елементи в яких номер стовпчика збігається із номером рядку) із блоків червого бетону (RED_CONCRETE)<br>2. Створіть квадрат 10х10 (цикл - від 0 до 9) з блоків білого бетону (WHITE_CONCRETE), при чому на старті агент має стояти в точці в абсолютних координатах (world) - (0,4,0) із орієнтацією на захід (WEST). В квадраті - сформуйте зворотню діагональ (елементи в яких номер стовпчика збігається із номером рядку) із блоків червого бетону (RED_CONCRETE)<br>1. Створіть квадрат довільного розміру із довільного матеріалу в довільному місці із довільною початковою орієнтацією агента. В квадраті - сформуйте зворотню діагональ (елементи в яких номер стовпчика збігається із номером рядку) із блоків довільного типу, але так, щоб блоки діагоналі відрізнялися від блоків основного квадрату.<br>|наведено вище|<img src = "img/pattern03.png">|
